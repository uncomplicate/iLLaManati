...
(defonce hftokenizer (hft "data/gemma-3-4b-pt/tokenizer.json"))
...
(facts "HF Tokenizer Hello World."
       (with-release [input "Hello, Gemma! How is the weather in Belgrade?"
         ...
         (fill! to-llm (second (ids pad-enc)))
...
(facts "Streaming decoder test."
       (with-release [input "Hello, Gemma! How is the weather in Belgrade?"
         ...
         (tokens encoding) => ["<bos>" "Hello" "," "▁Gemma" "!" "▁How" "▁is" "▁the" "▁weather" "▁in" "▁Belgrade" "?"]
         (apply str (mapv st decodable)) =>  (str "<bos>" input)))
...
(facts "HF Tokenizer with matrices."
       (with-release [input "Hello, Gemma! How is the weather in Belgrade?"
         ...
         (map seq (ids encoding)) => (repeat 3 [2 9259 236764 147224 236888 2088 563 506 7606 528 86221 236881])
         (map seq (cols (ids! encoding m))) => (repeat 3 [2 9259 236764 147224 236888 2088 563 506 7606 528 86221 236881])
